...
// @ts-ignore
import {ScrollResponderType} from 'react-native/Libraries/Components/ScrollView/ScrollView';
// @ts-ignore
import {ScrollViewNativeComponentType} from 'react-native/Libraries/Components/ScrollView/ScrollViewNativeComponentType.js';
...
import {RenderItemType, RenderItemProps} from 'react-native/Libraries/Lists/VirtualizedList';
...
_getItem = (data: Array<ItemT>, index: number) => {
  ...
  if (numColumns > 1) {
    ...
    for (let kk = 0; kk < numColumns; kk++) {
      if (index * numColumns + kk >= data.length) continue
